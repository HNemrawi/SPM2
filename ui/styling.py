...
# ==================== COLOR SYSTEM ====================
# Using a neutral color palette that adapts well to both themes
...
def apply_custom_css():
    """Apply the neutral theme CSS to the Streamlit app."""
...
def style_metric_cards(
    ...
    box_shadow_str = (
        "box-shadow: var(--shadow-md);"
        if box_shadow else "box-shadow: none;"
    )
...
def style_dataframe(
    ...
    if highlight_columns:
        def highlight_cols(s):
            return ['background-color: var(--bg-hover)' if s.name in highlight_columns else '' for _ in s]
...
def get_chart_colors() -> list:
    ...
    return NeutralColors.CHART_COLORS
...
__all__ = [
    ...
    'apply_custom_css',
    'style_metric_card',
    'style_metric_cards',  # Added for backward compatibility
    'create_info_box',
    'style_dataframe',
